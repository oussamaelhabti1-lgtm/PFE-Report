...
\subsection{NAT Port Forward (preuve \texttt{nat-rules-4.png})}
...
\subsection{Règle Pare-feu WAN (preuve \texttt{firewall-rules-4.png})}
...
La configuration est cohérente : port public \texttt{22/tcp} publié sur l'hôte et redirigé vers le port interne \texttt{2222/tcp} du conteneur Cowrie, avec état \textit{healthy} et service prêt.
