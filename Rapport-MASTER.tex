...
Ce chapitre déploie une infrastructure segmentée (WAN/DMZ/LAN) sous VMware Workstation : pare-feu pfSense, IDS Snort, pfBlockerNG, UFW et Fail2Ban. L'infrastructure constitue le socle commun à toutes les phases suivantes (voir Section~\ref{chap:introduction} pour les détails).

À l'issue de ce chapitre, l'étudiant maîtrise : déploiement VMware segmenté, configuration pfSense (routage inter-zone, NAT), sécurité périmétrique (Snort, pfBlockerNG, règles pare-feu), sécurité des hôtes (UFW, Fail2Ban, Docker), et analyse des logs firewall/IDS.
