...
Cette section détaille la mise en œuvre opérationnelle de cette base défensive : configuration réseau, filtrage périmétrique et durcissement de l'hôte DMZ.
...
\section{Introduction et Objectifs}
	...
	Ces validations ferment la chaîne attaque$\rightarrow$détection en complément du volet deception (Chapitre~5) et avant la corrélation SIEM (Chapitre~7).
