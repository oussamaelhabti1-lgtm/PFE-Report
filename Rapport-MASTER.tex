...
\begin{tcolorbox}[colback=primary!5!white, colframe=primary, title=\textbf{Objectifs du Chapitre}]
Cette phase présente les preuves de déploiement du 2026-04-15 : exposition SSH via pfSense, interception des sessions par Cowrie en conteneur Docker, puis corrélation avec la détection Snort.
\end{tcolorbox}

\section{Architecture de Déploiement et Flux Réseau}

Le chemin validé en production est : \texttt{Parrot (192.168.100.150) $\rightarrow$ pfSense WAN (192.168.100.6) $\rightarrow$ NAT WAN:22 $\rightarrow$ DMZ 192.168.10.100:2222 (Cowrie)}. Le service Cowrie tourne dans un conteneur Docker et capte les sessions SSH de reconnaissance réelles.
...
\begin{table}[H]
	...
	\begin{tabular}{p{2.8cm} p{4.1cm} p{4.8cm}}
		...
		\rowcolor{tablerowalt}
		Traduction NAT & WAN:22 $\rightarrow$ 192.168.10.100:2222 & Redirection vers le service honeypot \\
		Capteur Cowrie & 192.168.10.100:2222 & Conteneur Docker capturant auth + commandes + TTY \\
		\hline
	\end{tabular}
...
\begin{figure}[H]
	...
	\caption{Règle pfSense NAT activée : WAN:22 vers DMZ 192.168.10.100:2222}
...
\begin{table}[H]
	...
	\begin{tabular}{p{3.1cm} p{7.2cm}}
		...
		NAT Ports (Redirect target port) & 2222 \\
		\rowcolor{tablerowalt}
...
\subsection{Preuves issues des journaux Docker (2026-04-15)}

\begin{lstlisting}[language=bash, caption={Extrait des sessions réelles capturées par Cowrie}]
2026-04-15T01:04:38+0000 [cowrie.ssh.factory.CowrieSSHFactory] New connection: 192.168.100.150:xxxxx
2026-04-15T01:04:5x+0000 [HoneyPotSSHUserAuthServer] login attempt [ubuntuserver/******] failed

2026-04-15T01:05:xx+0000 [HoneyPotSSHUserAuthServer] login attempt [root/admin] succeeded
2026-04-15T01:05:xx+0000 [cowrie.command.input] CMD: ls
2026-04-15T01:05:xx+0000 [cowrie.command.input] CMD: whoami
2026-04-15T01:05:xx+0000 [cowrie.command.input] CMD: exit
2026-04-15T01:05:xx+0000 [cowrie.session.closed] duration=13.3

2026-04-15T01:08:xx+0000 [HoneyPotSSHUserAuthServer] login attempt [root/oussama] succeeded
2026-04-15T01:08:xx+0000 [cowrie.command.input] CMD: ls
2026-04-15T01:08:xx+0000 [cowrie.command.input] CMD: whomai
2026-04-15T01:08:xx+0000 [cowrie.command.input] CMD: uname
2026-04-15T01:08:xx+0000 [cowrie.command.input] CMD: whoami
2026-04-15T01:08:xx+0000 [cowrie.command.input] CMD: tail /etc/passwd
2026-04-15T01:08:24+0000 [cowrie.session.closed] duration=211.2
\end{lstlisting}
...
\begin{table}[H]
	...
	\begin{tabular}{>{\centering\arraybackslash}p{1.1cm} p{2.2cm} p{2.0cm} >{\centering\arraybackslash}p{1.4cm} p{4.4cm}}
		...
		\hline
	\end{tabular}
	\caption{Synthèse des sessions Cowrie capturées (01:04:38--01:08:24 UTC)}
...
\begin{table}[H]
	...
	\begin{tabular}{p{2.0cm} p{2.6cm} p{2.8cm} p{3.9cm}}
		...
		\hline
		\rowcolor{tablerowalt}
		02:02:22 & 192.168.100.150 & 192.168.100.6 & ET SCAN Potential SSH Scan (1:2001219) \\
		01:53:29 & 192.168.100.150 & 192.168.10.100 & ET SCAN Potential SSH Scan (1:2001219) \\
		\rowcolor{tablerowalt}
		01:44:20 & 192.168.100.150 & 192.168.100.6 & ET SCAN Potential SSH Scan (1:2001219) \\
		01:30:28 & 192.168.100.150 & 192.168.10.100 & ET SCAN Potential SSH Scan (1:2001219) \\
		\hline
	\end{tabular}
