...
\section{Introduction et Objectifs Pédagogiques}
	...
	\subsection{Contexte du Projet}
	Cette phase s\'inscrit dans la continuité de la Phase 1 et se concentre sur la dimension \textbf{offensive} de la cybersécurité. Après avoir mis en place une architecture réseau segmentée et sécurisée, l'objectif est maintenant d'adopter la perspective de l'attaquant pour évaluer la \textbf{surface d'attaque} exposée et comprendre les mécanismes de \textbf{réduction de cette surface}.
