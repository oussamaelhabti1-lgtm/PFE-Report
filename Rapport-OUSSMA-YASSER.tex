...
\hypersetup{
	...
	pdfauthor={Yasser Bella, Oussama El Habti --- Encadrante: Mme Salma El Bakkal},
...
{\normalsize\bfseries\color{black!40}\MakeUppercase{Rapport de Projet de Fin d'Études}}
...
\textbf{\color{primary}Encadrante :}\\[0.3cm]
...
% ==============================================================================
% CHAPITRE 1 : INFRASTRUCTURE DÉFENSIVE (TP-1)
% ==============================================================================
...
\section{Introduction et Objectifs Pédagogiques}
	...
	% ------------------------------------------------------------------------------
	\section{Réponses aux Questions de Réflexion}
	
	\subsection{Question 1 : Importance de la Segmentation Réseau}
	
	\subsubsection{Définition et Principe Stratégique}
	...
	\subsubsection{Risques sans Segmentation}
	...
	\subsubsection{Exemple Concret de Notre Laboratoire}
	\begin{itemize}
	...
	% ------------------------------------------------------------------------------
	\subsection{Question 2 : Rôle Principal de pfSense}
	...
	\paragraph{1. Routeur Inter-Zones}
	\begin{itemize}
	...
	\paragraph{3. NAT/PAT (Network Address Translation)}
	\begin{itemize}
	...
	\paragraph{4. Services Réseau Essentiels}
	\begin{itemize}
	...
	\subsubsection{Contribution à la Sécurité Globale}
	\begin{enumerate}
	...
	% ------------------------------------------------------------------------------
	\subsection{Question 3 : Déblocage des Réseaux Privés sur WAN}
	
	\subsubsection{Mécanisme de Blocage par Défaut}
	...
	\subsubsection{Pourquoi Désactiver dans Notre Laboratoire}
	...
	\subsubsection{Implications en Production}
	...
	\subsubsection{Preuve dans Nos Logs}
	...
	% ------------------------------------------------------------------------------
	\subsection{Question 4 : Modes de Carte Réseau (VMware/VirtualBox)}
	...
	% ------------------------------------------------------------------------------
	\subsection{Question 5 : Dépannage DHCP}
	
	\subsubsection{Scénario}
	La machine DMZ (Ubuntu) ne parvient pas à obtenir une adresse IP via DHCP après configuration initiale.
	
	\subsubsection{Méthodologie de Dépannage Systématique}
	
	\paragraph{Étape 1 : Vérifier la Configuration Réseau de la VM}
	...
	\paragraph{Étape 2 : Vérifier le Service DHCP sur pfSense}
	\begin{enumerate}
	...
	\paragraph{Étape 3 : Vérifier la Connectivité Réseau VMware}
	\begin{itemize}
	...
	\paragraph{Étape 4 : Capture de Paquets (Diagnostic Avancé)}
	...
	\paragraph{Étape 5 : Vérifier les Règles Firewall}
	...
	% ------------------------------------------------------------------------------
	\subsection{Question 6 : Intérêt Pédagogique des Erreurs Simulées}
	
	\subsubsection{Philosophie de l'Apprentissage par l'Erreur}
	...
	\subsubsection{Erreurs Rencontrées dans Notre TP}
	
	\paragraph{1. Désactivation du Blocage RFC1918 (Chapitre 3, Section 3.5)}
	\begin{itemize}
	...
	\paragraph{2. Erreur NAT Découverte (Chapitre 6, Phase 2)}
	...
	\paragraph{3. Blocage par "Default Deny" après Modification (Chapitre 6, Phase 3)}
	\begin{itemize}
	...
	\subsubsection{Bénéfices Globaux}
	\begin{enumerate}
	...
	% ------------------------------------------------------------------------------
	\subsection{Question 7 : Tableau Récapitulatif des Adresses IP}
	...
	\subsection{Commandes de Diagnostic Utiles}
	...
	\subsection{Extrait de Configuration pfSense (config.xml)}
	...
	\subsection{Procédure de Dépannage Rapide}
	\begin{enumerate}
...
% ==============================================================================
% CHAPITRE 2 : RECONNAISSANCE ACTIVE (TP-2)
% ==============================================================================
...
findtime = 600
	...
	\begin{tcolorbox}[colback=primary!5!white, colframe=primary, title=\textbf{AVERTISSEMENT : Ports closed mais règles NAT présentes}]
		Lors du scan Nmap, les ports 139 et 445 ont été détectés en état \textbf{closed} (service inactif). Cependant, des règles NAT existent dans pfSense (configurées au TP1). Si le service Samba venait à être démarré, ces ports seraient exposés au WAN --- d'où l'importance d'une analyse préventive.
	\end{tcolorbox}
	...
	\begin{itemize}
		\item \textbf{EternalBlue (MS17-010) :} Bien que ciblant SMBv1 sur Windows, des variantes Linux existent. Si Samba était actif et accessible, une tentative d'exploitation serait probable (comme observé en TP3 avec Windows XP).
...
[global]
   ...
   server min protocol = SMB2
	...
	\subsection{Question 1 : Surface d'Attaque et Stratégies de Réduction}
	
	\subsubsection{Définition de la Surface d'Attaque}
	...
	\subsubsection{Importance de la Réduction}
	...
	\subsubsection{Exemples Concrets pour un Serveur Web}
	
	\paragraph{1. Désactiver les Services Inutiles}
	...
	\paragraph{2. Utiliser des Ports Non-Standard (Security through Obscurity)}
	...
	\paragraph{3. Implémenter un Pare-feu Application (WAF)}
	...
	\paragraph{4. Restreindre l'Accès par IP (Whitelisting)}
	...
	\paragraph{5. Désactiver le Listing de Répertoires}
	...
	\paragraph{6. Supprimer les Comptes et Fichiers par Défaut}
	...
	% ------------------------------------------------------------------------------
	\subsection{Question 2 : Mécanisme du Port Forwarding}
	...
	\subsubsection{Mécanisme de Redirection du Trafic}
	
	\paragraph{Étapes de Traitement (Exemple : Telnet)}
	\begin{enumerate}
	...
	\subsubsection{Impact sur la Visibilité de l'Attaquant}
	\paragraph{Ce que l'Attaquant Voit}
	\begin{itemize}
	...
	\paragraph{Ce que l'Attaquant NE Voit PAS}
	\begin{itemize}
	...
	\subsubsection{Démonstration : État de la Table de Translation}
	...
	% ------------------------------------------------------------------------------
	\subsection{Question 3 : Objectif de Nmap en Reconnaissance}
	...
	\subsubsection{Types d'Informations Obtenues}
	
	\paragraph{1. Découverte d'Hôtes (Host Discovery)}
	...
	\paragraph{2. Scan de Ports (Port Scanning)}
	...
	\paragraph{3. Détection de Version (Service Version Detection)}
	...
	\paragraph{4. Détection d'OS (Operating System Detection)}
	...
	\paragraph{5. Scripts NSE (Nmap Scripting Engine)}
	...
	\subsubsection{Utilisation pour Planifier une Attaque}
	
	\paragraph{Flux de Travail Typique d'un Attaquant}
	\begin{enumerate}
	...
	\subsubsection{Exemple Concret : De Nmap à Exploit}
	...
	% ------------------------------------------------------------------------------
	\subsection{Question 4 : États de Port et Signification}
	
	\subsubsection{Port 80 : État "open"}
	
	\paragraph{Résultat Nmap}
	\begin{lstlisting}
		PORT   STATE SERVICE
		80/tcp open  http
	\end{lstlisting}
	
	\paragraph{Explication Technique}
	...
	\paragraph{Signification pour l'Attaquant}
	\begin{itemize}
	...
	\subsubsection{Port 22 : État "filtered"}
	...
	\subsubsection{Comparaison : open vs. filtered}
	...
	\subsubsection{Problème 1 : Pare-feu UFW Bloquant les Connexions}
	...
	\subsubsection{Problème 2 : Ports 139/445 en État "closed"}
	...
	\subsubsection{Monitoring et Détection}
	\begin{enumerate}
	...
	\subsection{Commandes Nmap Avancées}
	...
	\subsection{Configuration Complète UFW}
	...
	\subsection{Dépannage Réseau Avancé}
	...
	\subsubsection{Client Telnet Alternatif : BusyBox}
	...
	\paragraph{Utilisation de BusyBox Telnet}
	...
	\paragraph{Alternative : Installation du Client Telnet Classique}
	...
	\paragraph{Comparaison Technique}
	...
	\subsection{Scripts Automatisés}
	...
	\subsection{Captures d'Écran Supplémentaires}
	
	\subsubsection{Configuration Système Ubuntu DMZ}
	...
	\subsubsection{Configuration Réseau Parrot Security}
	...
	\subsection{Références de Configuration pfSense}
	
	\subsubsection{Règles NAT Configurées}
	...
	\subsubsection{Règles Firewall WAN Associées}
	...
	\subsection{Procédure de Reproduction Complète}
	
	\subsubsection{Étape 1 : Préparation de l'Environnement}
	\begin{enumerate}
	...
	\subsubsection{Étape 2 : Installation Telnet sur Ubuntu DMZ}
	...
	\subsubsection{Étape 3 : Configuration NAT sur pfSense}
	\begin{enumerate}
	...
	\subsubsection{Étape 4 : Tests depuis Parrot Security}
	...
	\subsubsection{Étape 5 : Analyse des Résultats}
	\begin{enumerate}
	...
	\subsection{Notes de Sécurité pour la Production}
	...
	\subsubsection{Outils Recommandés}
	\begin{itemize}
	...
	\subsubsection{Lectures Recommandées}
	\begin{itemize}
	...
	\subsubsection{Certifications Pertinentes}
	\begin{itemize}
...
% ==============================================================================
% CHAPITRE 3 : EXPLOITATION & POST-EXPLOITATION (TP-3)
% ==============================================================================
...
\section{Introduction et Contexte Opérationnel}
	...
	\subsubsection{Progression Pédagogique des Trois TP}
	...
	\subsubsection{Rappel des Acquis des TP Précédents}
	
	\paragraph{TP1 : Fondations Défensives}
	...
	\paragraph{TP2 : Préparation du Terrain d'Attaque}
	...
	\subsubsection{Positionnement du TP3}
...
\end{tcolorbox}
\subsection{Rappel : Vulnérabilités Identifiées (TP2)}
...
\subsection{Reconnaissance Initiale (Validation TP3)}
...
\subsubsection{Validation de la Chaîne TP1 → TP2 → TP3}
...
\end{table}
	...
	\subsubsection{Question 1 : Concept de Pivoting et Mouvement Latéral}
	...
	\paragraph{Pourquoi ces Techniques sont Cruciales}
	...
	\paragraph{Démonstration Pratique dans notre TP3}
	...
	\paragraph{Importance Stratégique}
	...
	\subsubsection{Question 2 : Avantages de Meterpreter}
	...
	\paragraph{Comparaison Shell Basique vs Meterpreter}
	...
	\paragraph{Trois Fonctionnalités Clés de Meterpreter}
	...
	\paragraph{Fonctionnalités Additionnelles (Bonus)}
	...
	\subsubsection{Question 3 : Impact de la Règle pfSense Permissive}
	...
	\paragraph{Configuration de la Règle Permissive}
	...
	\paragraph{Comment cette Règle a Facilité le Pivoting}
	...
	\subsubsection{Question 4 : Limitations des Logs Pare-feu}
	...
	\paragraph{Ce que pfSense Voit dans ses Logs}
	...
	\paragraph{Ce que pfSense NE Voit PAS}
	...
	\paragraph{Pourquoi pfSense est Structurellement Aveugle}
	...
	\paragraph{Technologies Nécessaires pour la Détection}
	...
	\subsection{Synthèse des Objectifs Atteints}
	...
	\subsubsection{Du Point de Vue de l'Attaquant}
	...
	\subsubsection{Du Point de Vue du Défenseur}
	...
	\subsection{Conformité avec les Objectifs Pédagogiques}
	...
	\subsection{Commandes de Diagnostic et Validation}
	
	\subsubsection{Vérification des Sessions Meterpreter}
	...
	\subsubsection{Commandes de Routage Metasploit}
	...
	\subsubsection{Commandes de Port Forwarding}
	...
	\subsection{Extraction des Données de Loot}
	...
	\subsection{Nettoyage et Remédiation}
	
	\subsubsection{Suppression des Traces d'Attaque}
	...
	\subsubsection{Hardening Post-Incident}
...
% ==============================================================================
% CHAPITRE 4 : DÉTECTION ACTIVE AVEC SNORT IDS (TP-4)
% ==============================================================================
...
\section{Introduction et Objectifs}
	...
	% ==============================================================================
	\section{Questions de Réflexion et Réponses}
	
	\subsection{Différence fondamentale pare-feu vs IDS/IPS}
	...
	\subsection{Comment Snort détecte via signatures (exemple concret)}
	...
	\subsection{Pourquoi la visibilité Snort est cruciale pour le mouvement latéral}
	...
	\subsection{Faux positifs : impacts et gestion}
	...
	% ------------------------------------------------------------------------------
	\appendix
	\section{Annexes : Captures et Preuves}
...
\subsection{Index des preuves (références rapides)}
...
\subsection{Commentaires sur la reproductibilité}
...
\subsection{Annexe A : Résumé des alertes exploitées (extraits)}
...
% ==============================================================================
% CHAPITRE 5 : EXPLOITATION WEB --- DVWA (OWASP TOP 10)
% ==============================================================================
...
\section{Introduction et Objectifs}
	...
	\section{Identification et Exploitation des Vulnérabilités OWASP Top 10: 2025}
	...
	\subsection{Tableau de Synthèse OWASP Top 10: 2025}
...
L'accès au processus \texttt{www-data} offre un point de départ pour explorer d'autres machines du réseau interne. Combiné avec le pivot Meterpreter établi en TP3, il permet de croiser les informations collectées.
...
\begin{table}[H]
	...
	\begin{tabular}{p{4cm} >{\centering\arraybackslash}p{2.5cm} p{6.5cm}}
		...
		\hline
		\rowcolor{tablerowalt}
		Web Shell Upload & ✅ Succès & Exécution de commandes OS arbitraires \\
		Credential Extraction & ✅ Succès & Credentials MySQL DVWA récupérés \\
		\rowcolor{tablerowalt}
		Password Cracking & ✅ Succès & 5/5 hashes MD5 crackés \\
		Lateral Movement & ✅ Succès & Accès au réseau DMZ et scan LAN \\
		\rowcolor{tablerowalt}
		Privilege Escalation & Conditionnelle & Dépend de la configuration du serveur \\
		Persistence & ✅ Succès & Web shell maintenu jusqu'à suppression manuelle \\
		\hline
	\end{tabular}
...
% ==============================================================================
% SECTION 11 : QUESTIONS DE RÉFLEXION ET BONNES PRATIQUES
% ==============================================================================
\section{Questions de Réflexion et Bonnes Pratiques}
\label{sec:dvwa-questions}

\subsection{Question 1 : Pourquoi la Validation des Entrées est-elle Fondamentale ?}

\paragraph{Question}
Expliquez pourquoi la validation des entrées côté serveur est le mécanisme de défense le plus important contre les injections SQL et les injections de commandes. Pourquoi la validation côté client seule est-elle insuffisante ?

\paragraph{Réponse}

La validation des entrées côté serveur est fondamentale car elle constitue la \textbf{dernière ligne de défense} contre les données malveillantes. Voici pourquoi la validation côté client est insuffisante :

\begin{enumerate}
	\item \textbf{Contournement trivial :} Les contrôles côté client (JavaScript, HTML) peuvent être désactivés ou contournés directement via les outils de développement du navigateur, Burp Suite, ou une simple requête curl.
	\begin{lstlisting}[caption=Contournement de la validation côté client]
# Envoi direct sans passer par le navigateur
curl -X POST "http://192.168.100.6/dvwa/vulnerabilities/sqli/" \
     -d "id=1' OR '1'='1&Submit=Submit" \
     --cookie "DVWASESSID=abc123; security=low"
	\end{lstlisting}
	
	\item \textbf{Le serveur doit assumer la méfiance :} Toute donnée provenant du client (navigateur, API, curl) doit être traitée comme potentiellement malveillante, conformément au principe \textbf{Never Trust User Input}.
	
	\item \textbf{Remédiation par Requêtes Préparées :}
	\begin{lstlisting}[language=PHP, caption=Requête préparée en PHP --- Défense contre SQLi]
// VULNÉRABLE : concaténation directe
$query = "SELECT * FROM users WHERE id = " . $_GET['id'];

// SÉCURISÉ : requête préparée (parameterized query)
$stmt = $pdo->prepare("SELECT * FROM users WHERE id = ?");
$stmt->execute([$_GET['id']]);
$result = $stmt->fetchAll();
	\end{lstlisting}
	
	\item \textbf{Remédiation par Assainissement pour Command Injection :}
	\begin{lstlisting}[language=PHP, caption=Assainissement pour Command Injection]
// VULNÉRABLE
...
\subsection{Question 2 : Stratégies de Validation des Entrées}

\paragraph{Question}
Quelles sont les stratégies de validation des entrées à mettre en œuvre pour une application web sécurisée ? Distinguez la validation de la sanitisation.

\paragraph{Réponse}

\textbf{Validation vs Sanitisation :}

\begin{itemize}
	\item \textbf{Validation :} Vérifier que les données correspondent au format attendu \textit{avant traitement}. Rejeter les données invalides.
	\item \textbf{Sanitisation (Assainissement) :} Nettoyer les données en supprimant ou encodant les caractères dangereux.
\end{itemize}
...
\begin{table}[H]
	...
	\begin{tabular}{p{3cm} p{5.5cm} p{5cm}}
		...
		\hline
		\tableheadcolor
		\textcolor{tableheadfg}{\textbf{Type d'Entrée}} &
		\textcolor{tableheadfg}{\textbf{Validation}} &
		\textcolor{tableheadfg}{\textbf{Sanitisation}} \\
		\hline
		\rowcolor{tablerowalt}
		ID numérique & \texttt{is\_int() / FILTER\_VALIDATE\_INT} & Caster en entier \\
		Adresse IP & \texttt{FILTER\_VALIDATE\_IP} & Rejeter si invalide \\
		\rowcolor{tablerowalt}
		Email & \texttt{FILTER\_VALIDATE\_EMAIL} & \texttt{filter\_var + htmlspecialchars} \\
		Nom de fichier & Regex \texttt{/\^{}[a-zA-Z0-9\_\-\.]+\$/} & Supprimer \texttt{../}, \texttt{/} \\
		\rowcolor{tablerowalt}
		Texte libre & Longueur max, charset & \texttt{htmlspecialchars()} \\
		\hline
	\end{tabular}
	\caption{Stratégies de Validation et Sanitisation par Type d'Entrée}
	\label{tab:validation-strategies}
\end{table}

\subsection{Question 3 : Encodage des Sorties (Output Encoding)}

\paragraph{Question}
Qu'est-ce que l'encodage des sorties et pourquoi est-il essentiel pour prévenir les attaques XSS (Cross-Site Scripting) ?

\paragraph{Réponse}

L'\textbf{encodage des sorties} consiste à transformer les caractères spéciaux en leur équivalent sûr avant de les afficher dans un contexte HTML, JavaScript, CSS ou URL. Il empêche l'interprétation du contenu utilisateur comme du code.

\begin{lstlisting}[language=PHP, caption=Encodage des sorties en PHP]
// VULNÉRABLE : affichage direct sans encodage (XSS possible)
echo "Bienvenue, " . $_GET['username'];

// SÉCURISÉ : encodage HTML (htmlspecialchars)
echo "Bienvenue, " . htmlspecialchars($_GET['username'], ENT_QUOTES, 'UTF-8');

// Pour les attributs HTML
echo '<input value="' . htmlspecialchars($value, ENT_QUOTES) . '">';

// Pour les contextes JavaScript (json_encode)
echo "<script>var user = " . json_encode($user_data) . ";</script>";
\end{lstlisting}

\textbf{Contextes d'Encodage :}
\begin{itemize}
	\item \textbf{HTML Body :} \texttt{htmlspecialchars()} --- convertit \texttt{<}, \texttt{>}, \texttt{\&}, \texttt{"}, \texttt{'}
	\item \textbf{HTML Attributs :} \texttt{htmlspecialchars()} avec \texttt{ENT\_QUOTES}
	\item \textbf{JavaScript :} \texttt{json\_encode()} ou bibliothèques spécialisées
	\item \textbf{URL :} \texttt{urlencode()} ou \texttt{rawurlencode()}
	\item \textbf{CSS :} Éviter l'injection dynamique dans les styles
\end{itemize}

\subsection{Question 4 : Mécanismes d'Authentification Sécurisée}

\paragraph{Question}
Quels mécanismes d'authentification permettent de protéger contre les attaques de brute force, de rejeu de session et de vol de cookies ? Expliquez la stratégie de défense en profondeur.

\paragraph{Réponse}

La protection de l'authentification nécessite une approche en couches :
...
\begin{table}[H]
	...
	\begin{tabular}{p{4cm} p{9.5cm}}
		...
		\hline
		\tableheadcolor
		\textcolor{tableheadfg}{\textbf{Mécanisme}} &
		\textcolor{tableheadfg}{\textbf{Description et Implémentation}} \\
		\hline
		\rowcolor{tablerowalt}
		Politique de mots de passe & Min. 12 caractères, complexité (maj/min/chiffres/symboles), vérification contre listes de mots de passe compromis (HaveIBeenPwned API) \\
		Rate Limiting & Limiter à 5 tentatives/minute par IP. Implémenter un délai exponentiel (1s, 2s, 4s...) après chaque échec. \\
		\rowcolor{tablerowalt}
		Account Lockout & Blocage temporaire (15 min) après 10 tentatives échouées. Notification par email de l'utilisateur légitime. \\
		CAPTCHA & Google reCAPTCHA v3 (invisible) après 3 échecs. Résout le problème des bots automatisés. \\
		\rowcolor{tablerowalt}
		MFA (Multi-Factor Auth) & TOTP (Google Authenticator), clés FIDO2/WebAuthn. Résiste aux attaques de credential stuffing. \\
		Sessions sécurisées & IDs de session longs (128+ bits), régénération après login, timeout d'inactivité (30 min), flag \texttt{HttpOnly + Secure + SameSite=Strict}. \\
		\rowcolor{tablerowalt}
		Hashing sécurisé & bcrypt (coût 12+), Argon2id, ou scrypt. \textbf{Jamais MD5 ou SHA1 non salés} (cassés en secondes). \\
		\hline
	\end{tabular}
	\caption{Mécanismes d'Authentification Sécurisée}
	\label{tab:auth-mechanisms}
\end{table}

\textbf{Impact de DVWA :} Les mots de passe DVWA sont stockés en MD5 sans sel (\textit{5f4dcc3b5aa765d61d8327deb882cf99 = "password"}). Un attaquant récupérant la base de données craque l'ensemble des mots de passe en quelques secondes avec des tables arc-en-ciel ou hashcat.

\subsection{Question 5 : En-têtes de Sécurité HTTP}

\paragraph{Question}
Quels en-têtes HTTP de sécurité doivent être configurés sur un serveur web pour réduire la surface d'attaque ? Expliquez le rôle de chacun.

\paragraph{Réponse}

Les \textbf{en-têtes HTTP de sécurité} sont des directives envoyées par le serveur au navigateur pour contraindre son comportement. Ils constituent une défense côté client complémentaire à la validation serveur.

\begin{lstlisting}[caption=En-têtes de sécurité recommandés --- Configuration Apache/Nginx]
...
# Referrer Policy - Limitation des informations référant
Referrer-Policy: strict-origin-when-cross-origin

# Permissions Policy - Désactivation des fonctionnalités dangereuses
Permissions-Policy: geolocation=(), camera=(), microphone=()

# X-XSS-Protection (legacy, remplacé par CSP)
...
\begin{table}[H]
	...
	\begin{tabular}{p{4.5cm} p{8.5cm}}
		...
		\hline
		\tableheadcolor
		\textcolor{tableheadfg}{\textbf{En-tête}} &
		\textcolor{tableheadfg}{\textbf{Protection Apportée}} \\
		\hline
		\rowcolor{tablerowalt}
		Content-Security-Policy & Prévient XSS en définissant les sources de contenu autorisées \\
		Strict-Transport-Security & Force HTTPS, protège contre les attaques de déclassement TLS \\
		\rowcolor{tablerowalt}
		X-Frame-Options & Empêche l'intégration dans des iframes (Clickjacking) \\
		X-Content-Type-Options & Empêche le navigateur de deviner le type MIME (MIME confusion attacks) \\
		\rowcolor{tablerowalt}
		Referrer-Policy & Contrôle les informations envoyées dans l'en-tête Referer \\
		Permissions-Policy & Désactive les APIs sensibles (caméra, géolocalisation) inutilisées \\
		\hline
	\end{tabular}
	\caption{En-têtes HTTP de Sécurité et leurs Protections}
	\label{tab:security-headers}
\end{table}

\subsection{Principes de Programmation Sécurisée}

\subsubsection{Défense en Profondeur Applicative}

La sécurité applicative repose sur l'application simultanée de plusieurs principes complémentaires. Ces principes, illustrés tout au long de ce chapitre par les vulnérabilités DVWA, forment le socle de la programmation sécurisée :

\begin{enumerate}
	\item \textbf{Never Trust User Input (NTUI) :} Toute entrée utilisateur est potentiellement malveillante. Valider et assainir systématiquement.
	
	\item \textbf{Principle of Least Privilege :} Les processus web (www-data) ne doivent accéder qu'aux ressources strictement nécessaires. Aucun accès root, aucune lecture de \texttt{/etc/shadow}.
	
	\item \textbf{Fail Securely :} En cas d'erreur, ne jamais divulguer de détails techniques (stack traces, requêtes SQL, chemins de fichiers). Afficher un message générique côté utilisateur, logger les détails côté serveur.
	
	\item \textbf{Defense in Depth :} Combiner WAF + validation serveur + encodage des sorties + en-têtes de sécurité. Aucun mécanisme seul n'est suffisant.
	
	\item \textbf{Security by Design :} Intégrer la sécurité dès la conception (OWASP SAMM, threat modeling) plutôt que de l'ajouter en post-production.
	
	\item \textbf{Secure Defaults :} Configurer les frameworks et bibliothèques avec les options les plus sécurisées par défaut (HTTPS, cookies sécurisés, headers de sécurité).
\end{enumerate}

\begin{tcolorbox}[colback=primary!5!white, colframe=primary, title=\textbf{Bilan du Chapitre 5}]
	DVWA a permis de démontrer concrètement les vulnérabilités OWASP Top 10 dans un environnement contrôlé. Les principes de remédiation présentés --- validation des entrées, encodage des sorties, authentification robuste, et en-têtes de sécurité --- constituent les fondements d'une application web sécurisée. La détection de ces attaques est complémentairement assurée par Snort IDS (Chapitre~\ref{chap:snort}), qui peut identifier les payloads malveillants au niveau réseau.
\end{tcolorbox}
